<?php
	...
	$query = "INSERT INTO funcionarios_tb (id_funcionario, nome, endereco, bairro, cidade, telefone, cpf, rg, email, nasc) 
...
<button>
	<a href="lista_funcionarios.php">Listar funcionarios</a>
</button>